...
badd +18 ~/Programming/Strategy/map.cc
badd +1 ~/Programming/Strategy/map.h
badd +2 ~/Programming/Strategy/Unit.h
badd +1 ~/Programming/Strategy/Unit.cc
badd +1 ~/Programming/Strategy/png.h
badd +1 ~/Programming/Strategy/png.cpp
...
badd +1 ~/Programming/Strategy/gtkmain.hpp
badd +1 ~/Programming/Strategy/gtkmain.cpp
badd +1 ~/Programming/Strategy/main.cpp
...
silent! normal! zE
let s:l = 13 - ((0 * winheight(0) + 26) / 52)
...
exe 'vert 1resize ' . ((&columns * 117 + 117) / 235)
exe 'vert 2resize ' . ((&columns * 117 + 117) / 235)
tabedit ~/Programming/Strategy/png.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/Programming/Strategy/png.h
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
exe 'vert 1resize ' . ((&columns * 117 + 117) / 235)
exe 'vert 2resize ' . ((&columns * 117 + 117) / 235)
tabedit ~/Programming/Strategy/gtkmain.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/Programming/Strategy/gtkmain.hpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
exe 'vert 1resize ' . ((&columns * 117 + 117) / 235)
exe 'vert 2resize ' . ((&columns * 117 + 117) / 235)
tabedit ~/Programming/Strategy/main.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ~/Programming/Strategy/main.hpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((44 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 14 - ((12 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 55 - ((51 * winheight(0) + 26) / 52)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
