...
set shortmess=aoO
badd +50 ~/Programming/Strategy/8.ses
...
badd +7 ~/Programming/Strategy/test.cc
...
badd +24 ~/Programming/Strategy/Makefile
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((30 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 16 - ((0 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 115 + 114) / 228)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((53 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 136 - ((42 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
