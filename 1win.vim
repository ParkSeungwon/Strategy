...
badd +11 ~/Programming/Strategy/Weapon.h
badd +17 ~/Programming/Strategy/point.cc
badd +17 ~/Programming/Strategy/time.cc
badd +658 ~/Programming/Strategy/1win.vim
badd +0 ~/Programming/Strategy/Terrain.cc
badd +0 ~/Programming/Strategy/Terrain.h
args Weapon.h
...
97
normal! 05|
tabedit ~/Programming/Strategy/Unit.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
52
normal! 0
tabedit ~/Programming/Strategy/Weapon.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 28 - ((24 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
normal! 030|
tabedit ~/Programming/Strategy/Terrain.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
