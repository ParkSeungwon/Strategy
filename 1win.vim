...
set shortmess=aoO
badd +1 ~/Programming/Strategy/gtk/darea.cc
badd +1 ~/Programming/Strategy/gtk/darea.h
badd +73 ~/darea.cc
badd +11 ~/Programming/Strategy/Makefile
...
badd +1 ~/Programming/Strategy/gtk/interface.h
badd +0 ~/Programming/Strategy/gtk/win.cc
badd +0 ~/Programming/Strategy/gtk/win.h
...
setlocal fen
silent! normal! zE
let s:l = 97 - ((1 * winheight(0) + 24) / 48)
...
19
normal! 0
tabedit ~/Programming/Strategy/gtk/win.cc
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit ~/Programming/Strategy/gtk/join.cc
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 89 - ((0 * winheight(0) + 23) / 46)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
normal! 038|
tabedit ~/Programming/Strategy/gtk/join.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
